...
function initLiveISTClock() {
  ...
  function getWeatherMetadata(code, isDay) {
    switch (code) {
      case 0: return { icon: isDay ? 'clear_day' : 'clear_night', desc: isDay ? 'Clear' : 'Clear Night' };
      case 1:
      case 2: return { icon: isDay ? 'partly_cloudy_day' : 'partly_cloudy_night', desc: 'Partly Cloudy' };
      case 3: return { icon: 'cloudy', desc: 'Cloudy' };
      case 45:
      ...
      case 71: case 73: case 75: case 77: return { icon: 'snowing', desc: 'Snow' };
      case 95: case 96: case 99: return { icon: 'thunderstorm', desc: 'Thunderstorm' };
      default: return { icon: isDay ? 'clear_day' : 'cloudy', desc: 'Clear' };
    }
  }
